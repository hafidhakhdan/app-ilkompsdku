...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/profil_ilkom.html");
    ...
    private void prepareMenuData() {
        ...
        MenuModel menuModel = new MenuModel("Ilmu Komunikasi PSDKU Pangandaran", true, true, ""); //Menu of Java Tutorials
